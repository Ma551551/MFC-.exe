...
#include "ChildFrm.h"
#include "MFC应用程序Doc.h"
#include "MFC应用程序View.h"
#include "FCool.h"
#include <afxmsg_.h>
...
BEGIN_MESSAGE_MAP(CMFC应用程序App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMFC应用程序App::OnAppAbout)
	// 基于文件的标准文档命令
...
CMFC应用程序App::CMFC应用程序App() noexcept
{
...
BOOL CMFC应用程序App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MFCTYPE,
		RUNTIME_CLASS(CMFC应用程序Doc),
		RUNTIME_CLASS(CChildFrame), // 自定义 MDI 子框架
		RUNTIME_CLASS(CMFC应用程序View));
	if (!pDocTemplate)
		return FALSE;
...
public:
	...
	afx_msg void OnTe32771();
	afx_msg void OnTe32772();
};
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	...
	ON_COMMAND(ID_TE_32771, &CAboutDlg::OnTe32771)
	ON_COMMAND(ID_TE_32772, &CAboutDlg::OnTe32772)
END_MESSAGE_MAP()

// 用于运行对话框的应用程序命令
void CMFC应用程序App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CMFC应用程序App::LoadCustomState()
{
}

void CMFC应用程序App::SaveCustomState()
{
}
